...
import { MetalSaviorsActor } from "./documents/actor.mjs";
import { MetalSaviorsItem } from "./documents/item.mjs";
...
Hooks.once('init', async function() {
  ...
  CONFIG.Item.documentClass = MetalSaviorsItem;
...
Hooks.once("ready", async function() {
  ...
  Hooks.on("dropActorSheetData", (actor, sheet, data) => MetalSaviorsActor.EnforceStrictItemUniqueness(actor, sheet, data));
